...
#define nstates1	106	/* :init: */
#define minseq1	10
#define maxseq1	114
#define endstate1	105

#define nstates0	11	/* WS */
#define minseq0	0
#define maxseq0	9
#define endstate0	10
...
#define Air1	(sizeof(P1) - Offsetof(P1, _2_3_6_i) - 1*sizeof(int))

#define PWS	((P0 *)this)
typedef struct P0 { /* WS */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, _1_1_nr) - 1*sizeof(int))
...
#define HAS_TRACK	0
/* hidden variable: */	int max_value_reached;
